...
### Useful links
* Browse the [API documentation](http://johnny-five.io/api/).
* Need to figure out what platform to use for a project? Have a look at the [Platform Support pages](http://johnny-five.io/platform-support/).
* Need inspiration for your next NodeBot? Check out the [examples](http://johnny-five.io/examples/).
* Want to stay up-to-date with projects in the community? Check out our [articles](http://johnny-five.io/articles/).
* Need NodeBots community or Johnny-Five project updates and announcements? [The news page](http://johnny-five.io/news/) is what you’re looking for.
